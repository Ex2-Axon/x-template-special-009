...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-linear-to-br from-pink-50 via-purple-50 to-sky-50 text-gray-700 font-sans relative overflow-x-hidden pb-16 selection:bg-pink-200 selection:text-pink-800">
        ...
        <header className="sticky top-0 z-40 bg-white/70 backdrop-blur-md border-b-2 border-pink-100/40 px-4 py-3 sm:px-8">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-linear-to-tr from-pink-300 via-purple-300 to-sky-300 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-pink-100 animate-wiggle">
                <Sparkles size={20} />
              </div>
              <div>
                <span className="font-extrabold text-transparent bg-clip-text bg-linear-to-r from-pink-500 via-purple-500 to-sky-500 text-xl tracking-tight">FairyMatch</span>
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="bg-linear-to-r from-pink-400 to-purple-400 text-white font-bold text-xs sm:text-sm px-4 py-2.5 rounded-2xl shadow-md shadow-pink-100 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-1.5"
              >
                <Plus size={16} />
        ...
        <section className="relative px-4 pt-10 pb-16 sm:px-8 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-gray-800 tracking-tight leading-none mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-pink-400 via-purple-400 to-sky-400">
          ...
          <div className="bg-white/90 p-3 rounded-3xl shadow-xl border-2 border-pink-100 max-w-2xl mx-auto flex flex-col sm:flex-row gap-2">
            ...
            <button className="bg-linear-to-r from-pink-400 via-purple-400 to-sky-400 text-white font-bold text-sm px-6 py-3 rounded-2xl hover:brightness-105 active:scale-95 transition-all">
              ค้นหาเลย
            </button>
          </div>
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-full border-2 text-xs sm:text-sm font-bold transition-all duration-300 cursor-pointer ${
                    isActive 
                      ? 'bg-linear-to-r from-pink-400 to-purple-400 text-white border-transparent shadow-md scale-105' 
        ...
        <section id="matchmaking" className="max-w-7xl mx-auto px-4 py-12 bg-white/40 rounded-[3rem] border border-pink-100/50 backdrop-blur-sm mb-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between px-6 mb-8 gap-4">
            ...
            <button
              onClick={() => setShowMatchModal(true)}
              className="bg-linear-to-r from-purple-400 to-sky-400 text-white font-extrabold text-xs sm:text-sm px-5 py-3 rounded-2xl shadow-lg hover:shadow-purple-200 hover:scale-105 active:scale-95 transition-all flex items-center gap-1.5 self-start md:self-auto"
            >
              <Plus size={18} />
                ...
                >
                  <div>
                    ...
                    <div className="relative h-64 overflow-hidden bg-pink-100">
                      ...
                      {/* แท็กตกแต่งประเภท */}
                      <span className="absolute bottom-3 left-3 bg-linear-to-r from-pink-400 to-purple-400 text-white font-bold text-[10px] px-3 py-1 rounded-full">
                  ...
                  <div className="p-5 pt-0">
                    <button 
                      ...
                      className="w-full bg-linear-to-r from-pink-100 via-purple-100 to-sky-100 hover:from-pink-200 hover:to-sky-200 text-pink-700 font-bold text-xs py-2.5 rounded-2xl transition-all duration-300 flex items-center justify-center gap-1"
                    >
        ...
        <section id="certificates" className="max-w-7xl mx-auto px-4 py-12 bg-linear-to-r from-amber-50/70 via-pink-50/70 to-purple-50/70 rounded-[3rem] border border-pink-100/40 backdrop-blur-sm mb-16">
        ...
        <section id="contact" className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-[3rem] border-2 border-pink-100 shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-5">
            ...
            <div className="md:col-span-2 bg-linear-to-b from-pink-200 via-purple-100 to-sky-100 p-8 flex flex-col justify-between text-pink-700 relative">
            ...
            <form onSubmit={handleContactSubmit} className="md:col-span-3 p-8 sm:p-10 space-y-5 bg-white">
              ...
              <button 
                type="submit"
                className="w-full bg-linear-to-r from-pink-400 via-purple-400 to-sky-400 text-white font-bold text-sm py-3.5 rounded-2xl shadow-lg hover:shadow-pink-100 hover:brightness-105 active:scale-98 transition-all flex items-center justify-center gap-1.5"
              >
                <Send size={16} />
        ...
        <footer className="text-center mt-20 pt-10 border-t border-pink-100/60 max-w-7xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            {/* โลโก้ฟุตเตอร์ */}
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-linear-to-tr from-pink-300 to-purple-300 rounded-xl flex items-center justify-center text-white shadow-md">
                <Sparkles size={16} />
              </div>
              <span className="font-extrabold text-transparent bg-clip-text bg-linear-to-r from-pink-500 to-purple-500 text-base">FairyMatch</span>
            </div>
        ...
        {selectedStaff && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-[2.5rem] border-2 border-pink-100 shadow-2xl max-w-md w-full overflow-hidden animate-zoom-in">
              ...
              <div className="h-28 bg-linear-to-r from-pink-200 via-purple-200 to-sky-200 relative">
                <button 
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-fade-in">
            ...
            >
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button 
                  type="submit"
                  className="flex-1 bg-linear-to-r from-pink-400 to-purple-400 hover:brightness-105 text-white font-bold text-xs py-3.5 rounded-2xl text-center shadow-md transition-all"
                >
                  ลงประกาศด่วน 🚀
                </button>
              </div>
